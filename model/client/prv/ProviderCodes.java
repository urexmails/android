...
public class ProviderCodes extends Vector<ReferenceIDDropDown> implements KvmSerializable,
		Serializable {
	...
	public ProviderCodes(){}

	public ProviderCodes(SoapObject soapObject)
	{
		if (soapObject != null){
