...
public class Name implements KvmSerializable, Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -5094224737944215427L;
	...
	public Name(SoapObject soapObject){
		...
		if (soapObject.hasProperty("Title"))
		{
			...
			if (obj != null && obj.getClass().equals(SoapPrimitive.class)){
				SoapPrimitive j4 =(SoapPrimitive) soapObject.getProperty("Title");
				title = j4.toString();
			}
		}
		if (soapObject.hasProperty("FirstName"))
		{
			...
			if (obj != null && obj.getClass().equals(SoapPrimitive.class)){
				SoapPrimitive j5 =(SoapPrimitive) soapObject.getProperty("FirstName");
				firstName = j5.toString();
			}
		}
		if (soapObject.hasProperty("MiddleName"))
		{
			...
			if (obj != null && obj.getClass().equals(SoapPrimitive.class)){
				SoapPrimitive j6 =(SoapPrimitive) soapObject.getProperty("MiddleName");
				middleName = j6.toString();
			}
		}
		if (soapObject.hasProperty("LastName"))
		{
			...
			if (obj != null && obj.getClass().equals(SoapPrimitive.class)){
				SoapPrimitive j7 =(SoapPrimitive) soapObject.getProperty("LastName");
				lastName = j7.toString();
			}
		}
	}
	@Override
