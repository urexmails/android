...
public class PhotoConfig extends Vector<ReferenceIDDropDown> implements
		KvmSerializable, Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -8559240874221613403L;
	public static final String NAMESPACE = "http://TMSConsultant.Model/2013/TMSConsultant";

	public PhotoConfig(){}

	public PhotoConfig(SoapObject soapObject)
	{
		if (soapObject != null){
